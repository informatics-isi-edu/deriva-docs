...
![screenshot of example landing page.](/images/chaise-landing-page-example.jpg)

Above is a typical example using example (example.org). Common elements are:
...
![Screenshot of example filtering sidebar](/images/chaise-filter-sidebar-example.jpg)
...
For filters with a long list of attributes, you can either:

* Use the small search box within the filter to search across those attributes.
* Click "Show Details" to pull up a window to access all of the attributes. Within that window, you can also open its own filtering sidebar to further refine attribute search.

## Search results area

![Screenshot of example recordset view](/images/chaise-recordset-example.jpg)
...
![screenshot of example recordset download](/images/chaise-recordset-download-example.jpg)
