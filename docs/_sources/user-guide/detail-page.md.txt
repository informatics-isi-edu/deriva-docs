...
For example, in the demo repository a Study record is linked to one more Collections and Experiments, as pictured below.
...
The left sidebar is a 'Table of Contents' of sorts for the record page, called "Sections". Every section is linked there and you can click to go directly to that section.
